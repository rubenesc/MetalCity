...
package com.metallium.utils.image.encoders;
...
* an image.
 *
 * I took this from package "ImageJ" package "ij.io"
*/
...
public class JpegEncoder
{
    ...
    static {setQuality(defaultQuality);}
    ...
    public void Compress() {
        ...
        try {
                ...
                LogHelper.makeLog("IO Error: " + e.getMessage());
        }
    }
